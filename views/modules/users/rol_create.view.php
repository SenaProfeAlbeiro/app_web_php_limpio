			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-plus fa-fw"></i> &nbsp; REGISTRAR ROL
				</h3>
			</div>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a class="active" href="?c=Users&a=rolCreate"><i class="fas fa-plus fa-fw"></i> &nbsp; REGISTRAR ROL</a>
					</li>
					<li>
			...
			<div class="container-fluid">
				<form action="" method="POST" class="form-neon" autocomplete="off">
					<fieldset>
						<legend><i class="fas fa-user-graduate fa-fw"></i> &nbsp; Rol</legend>
						<div class="container-fluid">
							<div class="row">
